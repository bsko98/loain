import { bossNameData, classNameData, titleNameData, cardNameData, serverNameData } from "../mappers/dataMapTransformer"
...
export const partyDTOconverter = (partyDTOData) => {
    return {
        ...
        partyMembers: partyDTOData.partyMembers.map((member) => member?publicUserDTOconverter(member):null),
