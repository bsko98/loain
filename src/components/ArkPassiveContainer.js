  ...
  return (
    <div className="arkpassive">
      <div className="arkpassive-box">
        ...
        <div className="arkpassive-value">
          {formatValue(
            state.myData.userData.chooseCharacter
              ? state.myData.userData.chooseCharacter.arkPassive.evolution
              : 0
          )}
        </div>
      </div>
      <div className="arkpassive-box">
        ...
        <div className="arkpassive-value">
          {formatValue(
            state.myData.userData.chooseCharacter
              ? state.myData.userData.chooseCharacter.arkPassive.enlightenment
              : 0
          )}
        </div>
      </div>
      <div className="arkpassive-box last">
        ...
        <div className="arkpassive-value">
          {formatValue(
            state.myData.userData.chooseCharacter
              ? state.myData.userData.chooseCharacter.arkPassive.leap
              : 0
          )}
        </div>
      </div>
