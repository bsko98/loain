      ...
      <div className="manage-my-account-container">
        ...
        <div className="manage-my-account-email-box">
          ...
          <div className="manage-my-account-email-input-row">
            <input
              className="manage-my-account-email-input"
              value={emailInputValue}
              type="text"
              onChange={handleEmailInputChange}
            />
            <button
              className={`${emailInputValue ? 'manage-my-account-email-btn-active' : 'manage-my-account-email-btn'}`}
            >
              저장
            </button>
          </div>
        ...
        <div className="manage-my-account-api-box">
          <div className="manage-my-account-api-row">
            <div className="manage-my-account-api-title-row">
              <APIKeyImage />
              <span className="manage-my-account-api-txt">
                로스트아크 API Key
              </span>
            </div>
            <div
          ...
          <div className="manage-my-account-api-input-row">
            ...
            ></textarea>
            <button
              className={`${apiKeyInputValue ? 'manage-my-account-api-btn-active' : 'manage-my-account-api-btn'}`}
            >
              저장
            </button>
          </div>
        ...
        <div className="manage-my-account-btn-box">
          <button
            className="manage-my-account-btn"
            onClick={() => setDeleteIdModal(!deleteIdModal)}
          >
            회원 탈퇴
          </button>
          <button
