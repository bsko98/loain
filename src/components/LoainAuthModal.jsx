        ...
        <div className="loain-auth-modal-box">
          ...
          <div className="loain-auth-second-row">
            <div
              className={
                type === 'web'
                  ? 'loain-auth-second-row-state-active'
                  : 'loain-auth-second-row-state'
              }
              onClick={() => setType('web')}
            >
              브라우저 기준
          ...
          <div className="loain-auth-content-container">
            <div className="loain-auth-content-box">
              ...
              <input
                className="loain-auto-content-input"
                placeholder="프로필 페이지 주소(URL)를 입력해주세요."
                onChange={handleUrl}
              />
            </div>
          </div>
