import { classNameData, serverNameData, titleNameData } from "../dataMapTransformer";
...
export class CharacterEntityMapper {
    static toInternal(character) {
        return {
            ...
            name: character.name,
            serverName: character.serverName?serverNameData.toInternal(character.serverName):undefined,
